# ui_extras.py
"""Petits éléments visuels propres à client-maths (badges, puces de stats,
fond animé), pour donner à l'écran un aspect « jeu » plutôt que « formulaire ».

Reprend des motifs déjà éprouvés ailleurs dans le dépôt (badges/puces du Hub,
étoiles de client-dictee::CityManager) mais réimplémentés localement : ce
fichier n'importe rien de client-hub/client-dictee, seulement les primitives
partagées de commun/theme.py et commun/ui_widgets.py.
"""
