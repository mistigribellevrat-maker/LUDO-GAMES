# services.py
"""Services audio du jeu de conjugaison — copie allégée de la partie générique
de client-dictee/services.py (TTSService), sans les services propres à la
dictée (Gemini, lecteur vidéo, anti-triche). Pas d'appel IA dans ce jeu : les
vagues sont générées localement (voir problems.py), donc pas de clé API
...
class TTSService:
    ...
    Voir client-dictee/services.py::TTSService pour le
