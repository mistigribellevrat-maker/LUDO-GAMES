...
class GameLauncher:
    ...
    # ui_components.py, ui_extras.py, problems.py, conjugation_data.py, assets/,
    # commun/, manifest.json, ...) a cette adresse et mettre a jour BASE_URL en
    # consequence (meme principe que client-dictee/launcher.py, qui pointe vers
    # .../games1/, et client-maths/launcher.py vers .../games2/).
    BASE_URL = "https://www.gregbellevrat.fr/games/games3/"
    MANIFEST_FILE = "manifest.json"
    GAME_EXECUTABLE = "main.py"

    def __init__(self, root):
        self.root = root
        self.root.title("Tourelle de Défense - Launcher")
